    ...
    try {
        ...
        if ($action === 'remove' && $watch_id) {
            ...
            if ($quantity < 1) {
                ...
                $stmt = $conn->prepare($sql);
                $stmt->execute([$quantity, $user_id, $watch_id]);
...
<body>
    ...
    <nav class="nav">
        <ul>
            ...
            <li><a href="/php/cart.php" class="active">Cart</a></li>
            ...
            if (data.items.length === 0) {
                container.innerHTML = `
                    <div class="empty-cart">
                        ...
                        <a href="/php/catalog.php" class="checkout-btn" style="max-width: 300px; margin: 0 auto;">Browse Watches</a>
                    </div>
                `;
                return;
            }
            ...
            container.innerHTML = `
                <div class="cart-content">
                    ...
                    <div class="cart-summary">
                        ...
                        <a href="/php/catalog.php" class="continue-shopping">Continue Shopping</a>
                    </div>
                </div>
            `;
        ...
        function createCartItem(item) {
            ...
            itemDiv.innerHTML = `
                <div class="item-image">
                    ${item.image_url ? `<img src="${item.image_url.startsWith('/') ? item.image_url : '/' + item.image_url}" alt="${item.name}">` : '<div style="color:#666;">No Image</div>'}
                </div>
